...
RET
@
@ INPUTS: HL - INT(HL), DE - FP16 NUMBER
@ OUTPUT: HL - (FP16)(DE-HL)*1000
FRAC1K:
PUSH D
CALL INTF16
XCHG
...
POP D
POP PSW
JNC F16S2 @ FP16 IS LARGER THAN 9, LIMIT TO 3 DIGITS OF FRACTION
MVI A,'0'
CALL INTSTR
DB 3EH @ MVI A,D8 OPCODE
F16S3:
STAX D
...
CALL BDSTR
@ === UNSUPPORTED ===
@LXI H,1 @ MIN. SUBNORMAL 0.000000059605
@CALL BDSTR
@LXI H,03FFH @ MAX. SUBNORMAL 0.000060976
@CALL BDSTR
@ === UNSUPPORTED ===
LXI H,0400H @ MIN. NORMAL 0.000061035
CALL BDSTR
LXI H,F16_1-1 @ 0.999511
CALL BDSTR
LXI H,F16_1+1 @ 1.000976
CALL BDSTR
LXI H,F16_1
LXI D,4200H @ 3
CALL F16DIV @ 1/3
